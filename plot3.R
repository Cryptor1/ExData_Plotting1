#' Energy Sub Metering at Given Time Instant
#' 
#' Creates a graph representing energy sub meters values (Y axis) at given
#' time instant (X axis). The graph created is saved in the working directory as
#' 'plot3.png' file.
#' 
...
plot3 <- function(download_data = TRUE)
{
	suppressMessages(
		{
			library(dplyr)
